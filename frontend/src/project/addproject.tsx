...
const AddProject = (props: any) => {
    ...
    const addCall = () => {
        const call = {
            method: "Post",
            url: util.getUrlBase() + "/project/add-project",
            data: form,
    ...
    const updateCall = () => {
        const call = {
            method: "Put",
            url: util.getUrlBase() + "/project/update-project/" + id,
            data: form,
            withCredentials: true
        };
        const res = util.axiosCall(call);
        ...
        <div className='modal' onClick={props.onClose}>
            <div className='modal-content' onClick={e => e.stopPropagation()}>
                ...
                <div className='modal-body'>
                    ...
                    <textarea id="DescriptionInput" name="description" onChange={(e) => onChange(e.target.name, e.target.value)} />
                    <div>
